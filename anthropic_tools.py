...
class AnthropicToolAgentAction(AgentActionMessageLog):
    tool_call_id: str
...
def _create_tool_message(
    agent_action: AnthropicToolAgentAction, observation: str
) -> ToolMessage:
...
def format_to_anthropic_tool_messages(
    ...
    for agent_action, observation in intermediate_steps:
        if isinstance(agent_action, AnthropicToolAgentAction):
