...
class ZeroScopeAPI:
    ...
    def get_detail_of_the_token(self, token_address, chain):
        """Get detail of the token."""
        url = f'{self.base_url}/token/detail?token_address={token_address}&chain={chain}'
        response = requests.get(url, headers=self.headers)
        return response.json()

    def get_holders_count_of_the_token(self, token_address, chain):
    ...
    def get_transfers_of_the_token(self, token_address, chain, limit=10, page=1):
    ...
    def get_top_1000_holders_of_the_token(self, token_address, chain):
    ...
    def get_volume_of_token_deposit_to_cex_hourly(self, token_address, chain):
    ...
    def get_volume_of_token_withdraw_from_cex_hourly(self, token_address, chain):
    ...
    def get_amount_of_token_held_by_cex_address(self, token_address, chain):
        """Get amount of the token held by CEX address."""
        url = f'{self.base_url}/token/cexHolding?token_address={token_address}&chain={chain}'
        response = requests.get(url, headers=self.headers)
        return response.json()

    def get_supported_projects(self, chain, limit=10, page=1):
        """Get supported projects."""
        url = f'{self.base_url}/project/supported?chain={chain}&limit={limit}&page={page}'
        response = requests.get(url, headers=self.headers)
        return response.json()

    def get_detail_of_the_project(self, project_id, chain):
        """Get detail of the project."""
        url = f'{self.base_url}/project/detail?project_id={project_id}&chain={chain}'
        response = requests.get(url, headers=self.headers)
        return response.json()

    def get_tvl_of_the_project(self, project_id, chain, date):
        """Get tvl of the project."""
        url = f'{self.base_url}/project/tvl?project_id={project_id}&chain={chain}&date={date}'
        response = requests.get(url, headers=self.headers)
        return response.json()

    def get_daily_active_address_of_the_project(self, project_id, chain, date):
    ...
    def get_daily_active_entity_of_the_project(self, project_id, chain, date):
    ...
    def get_reasons_why_2_addresses_are_connected(self, address, related_address, chain):
    ...
    def divide_addresses_into_entities(self, addresses, chain):
    ...
    def get_entity_risk_score(self, address, chain):
    ...
    def risk_detection_in_contract(self, contract_address, chain):
    ...
    def simulate_transaction_risk(self, chain, block_number, transaction):
    ...
    def get_twitter_activity_chart(self, address, chain):
    ...
    def get_twitter_records_official(self, address, chain, limit=10, page=1):
    ...
    def get_twitter_records_not_official(self, address, chain, limit=10, page=1):
    ...
    def get_nft_price_chart(self, contract_address, chain, range='1d'):
    ...
    def get_nft_volume_chart(self, contract_address, chain, range='1d'):
    ...
    def get_nft_holder_statistics(self, contract_address, chain):
    ...
    def get_nft_holder_statistics_daily(self, contract_address, chain, date):
    ...
    def get_nft_top_100_holders(self, contract_address, chain):
    ...
    def get_nft_trades(self, contract_address, chain, begin_time, end_time, limit=10, page=1):
    ...
    def get_nft_profit_leader_board(self, contract_address, chain, limit=10, page=1):
